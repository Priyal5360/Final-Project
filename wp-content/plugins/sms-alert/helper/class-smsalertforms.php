...
class SMSAlertForms extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        if (!empty($form_list)) { ?>
            ...
            switch ($values) {
            case 1:
                echo do_shortcode("[sa_signupwithmobile sa_label='".$sa_ele_f_mobile_lbl."' sa_placeholder = '".$sa_ele_f_mobile_place."' sa_button = '".$sa_ele_f_mobile_botton."']");
                break; 
            case 2:
                echo do_shortcode("[sa_loginwithotp sa_label='".$sa_ele_f_mobile_lbl."' sa_placeholder = '".$sa_ele_f_mobile_place."' sa_button = '".$sa_ele_f_mobile_botton."']");
                break; 
            case 3:
