...
class Shortcode
{
    ...
    public function addSaLoginwithotp($callback=null)
    {
        ...
        get_smsalert_template('template/login-with-otp-form.php', array('label_field'=>$label_field, 'placeholder_field'=>$placeholder_field, 'button_field'=>$button_field));
    ...
    public function addSaSignupwithmobile($callback=null)
    {
        ...
        get_smsalert_template('template/sign-with-mobile-form.php', array('label_field'=>$label_field, 'placeholder_field'=>$placeholder_field, 'button_field'=>$button_field));
