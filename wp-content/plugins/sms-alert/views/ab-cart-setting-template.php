    ...
    <div class="accordion-section">        
        ...
        <div style="padding: 5px 10px 10px 10px;">    
            <table class="form-table">    
                ...
                <a href="javascript:void(0)" data-parent_id="smsalert_abandoned_cart[cart_exit_intent_status]" id="btn_reset_style" temp-style="exitintent_style" class="btn_reset_style btn-outline" style="float:left;"><?php esc_html_e('Reset', 'sms-alert'); ?></a>
                <?php
				}
				?>
