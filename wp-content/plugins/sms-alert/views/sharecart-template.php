    ...
    <div style="padding: 5px 10px 10px 10px;">    
            ...
            <tr valign="top">
             ...
             <tr>
                ...
                <a href="javascript:void(0)" data-parent_id="<?php echo esc_attr($template['checkboxNameId']); ?>" id="btn_reset_style" temp-style="sharecart_style" class="btn_reset_style btn-outline" style="float:left;"><?php esc_html_e('Reset', 'sms-alert'); ?></a>
                <?php
				}
				?>
