...
class SAFormMaker extends FormInterface
{
    ...
    {
        add_action('fm_addon_frontend_init', array( $this, 'formMarkerSubmissionComplete' ), 10, 1);
    ...
    /**
     * Process formmarker form submission and send sms
     *
     * @param int $form form.
     *
     * @return void
     */
    public function formMarkerSubmissionComplete($form )
    {
    ...
    {
        $tabs['formmarker']['nav']  = 'Form Marker';
        ...
        $tabs['formmarker']['inner_nav']['formmarker_cust']['filePath']     = 'views/formmarker_customer_template.php';
        ...
        $tabs['formmarker']['inner_nav']['formmarker_admin']['filePath']    = 'views/formmarker_admin_template.php';
    ...
    /**
     * Get default settings for the smsalert formmarker forms.
     *
